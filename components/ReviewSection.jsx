  ...
  return (
    <div className='mt-10 px-10 md:px-20'>
        ...
        <div class="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
            ...
            <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-bl-lg md:border-b-0 md:border-r dark:bg-gray-800 dark:border-gray-700">
                <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            ...
            <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-gray-200 rounded-br-lg md:rounded-br-lg dark:bg-gray-800 dark:border-gray-700">
                ...
                <figcaption class="flex items-center justify-center space-x-3 pl-6 ">
                    ...
                    <div class="space-y-0.5 font-medium dark:text-white text-left">
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">NasiLemak4U Owner</div>
                    </div>
                </figcaption>    
            </figure>
        </div>
