...
const landing = () => {
  return (
    <>
        <Navbar/>
        <section className='container mx-auto pt-2 md:pt-10'>
            <UnderConstructionAlert/>
            <h3 className='text-white text-xl font-semibold mb-0 md:mb-10 text-center invisible md:visible md:text-9xl '>parcel4you</h3>
            {/* <p className='text-gray-300 text-xl text-center'> 
                Your one-stop-shop for parcel delivery fees comparisons.
            </p> */}
            <blockquote class="text-xl text-center italic font-semibold text-white mx-10 md:mx-0">
                ...
                <p>Your one-stop-place for parcel delivery fees comparisons <span className="not-italic">🚚👍</span> </p>
            </blockquote>
            <ContactDrawer/>
            <ReviewSection/>
            <ServiceProvider/>
